...
if __name__ == '__main__':
    print("=======================================1=======================================")
    x_train, y_train, tag_encoder = dataset_tf.create_inputs_targets(config_tf.TRAINING_FILE)
    ...
    if use_tpu:
        ...
        tf.config_tf.experimental_connect_to_cluster(tpu)
    ...
    plt.legend(['Train', 'Validation'], loc='best')
    plt.show()
    my_model.save(config_tf.MODEL_PATH)
    # model.save_weights(config_tf.WEIGHT_PATH)
